...
export function universe_grid(a: number): number;
export function universe_get(a: number, b: number, c: number): number;
...
export function universe_delta(a: number): number;
export function universe_new(): number;
export function universe_update(a: number): void;
